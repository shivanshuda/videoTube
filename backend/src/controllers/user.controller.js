...
const loginUser = asyncHandler(async (req, res) => {
    ...
    //await user.save({ validateBeforeSave: false }); – This line is saving the user object to the
    //  database without running validation checks. This is useful when you’re certain that the 
    // document is in a valid stae but want to skip validation, typically for operations like 
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    if (!(newPassword === confPassword)) {
        throw new ApiError(
            400,
            "New Password & Confrom Password are not match "
        );
    }
